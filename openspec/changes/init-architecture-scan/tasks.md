...
- [x] Move module-level technology and middleware evidence into the internal Architect Agent flow.
- [x] Move final architecture analysis responsibility into the `/auok init` model-driven skill flow.
